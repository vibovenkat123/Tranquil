...
struct JournalView: View {
    ...
    var body: some View {
        Background {
            NavigationStack {
                ZStack {
                    Color(Globals().offPrimary).ignoresSafeArea(.all)
                    VStack {
                        Text("Journal")
                        ...
                        NavigationLink {
                            AllJournalView(context: context)
                        } label: {
                            Label("All Entries", systemImage: "arrow.right")
                                .font(CreateFont())
                                .foregroundStyle(Globals().primaryColor)
                        }
...
struct AllJournalView: View {
    ...
    @Query(sort: \.date, order: .reverse) var entries: [Entry]
    var body: some View {
        List(entries) { entry in
            EntryRow(context: context, entry: entry)
        }
    }
}
